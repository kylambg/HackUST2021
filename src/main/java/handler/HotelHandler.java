...
public class HotelHandler extends ServerRequestHandler {
    ...
    public void handle(String httpMethod, String path, Map<String, String> param, @Nullable InputStream request, HttpResponse response) throws InternalServerException{
        ...
        try{
            HotelSearchRequest.Builder builder = new HotelSearchRequest.Builder();
            ...
            HotelSearchResponse searchResponse = HotelService.getInstance().searchHotel(builder.build());
            if (searchResponse.getTotalNumHotel() == 0){
