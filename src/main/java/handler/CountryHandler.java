...
public class CountryHandler extends ServerRequestHandler {
    ...
    public void handle(String httpMethod, String path, @Nullable Map<String, String> param, @Nullable InputStream requestBody, HttpResponse response) throws InternalServerException {
        if (!httpMethod.equalsIgnoreCase("GET")) {
            ...
            try {
                CountrySearchResponse searchResponse = CountryService.getInstance().searchCountry();
                if (searchResponse.getTotalNumCountry() == 0) {
